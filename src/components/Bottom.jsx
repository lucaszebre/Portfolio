...
const Bottom = ({ref}) => {
    ...
    <>  
        <Toaster/>
        <div ref={ref} className="w-full h-full py-10 flex flex-col justify-center items-center bg-[#242424] relative">
        <img className="absolute z-10 lg:top-[14vw] md:top-[39vw]  max-md:top-[50vw] max-md:left-[-20rem] left-[-4rem]" src={"./assets/images/pattern-rings.svg"} alt="background-pattern" />
             ...
             v={{
                ...
                <Reveal v={{
                    ...
                    <form className='flex flex-col items-end mt-[1em]' action="" onSubmit={handleSubmit}>
                        ...
                        <textarea type="text" onChange={e => setMessage(e.target.value)} placeholder='MESSAGE' className="w-[85vw] lg:w-[30vw] h-[10vw] overflow-x-auto bg-none bg-transparent outline-0 mb-[1.5em] border-white text-white border-b-[1px]"  />
            ...
            <Reveal v={{
                ...
                <a href="https://github.com/lucaszebre" target="_blank"><img src={github} alt="github-logo" className='max-md:w-[3vw] mr-[1vw] max-md:min-w-[19.2px] md:w-[3vw] lg:w-[2vw]' /></a>
                <a href="https://www.frontendmentor.io/profile/Kihura" target="_blank"><img src={frontend} alt="frontend-logo" className='max-md:w-[3vw] mr-[1vw] max-md:min-w-[19.2px] md:w-[3vw] lg:w-[2vw]' /></a>
                <a href="https://www.linkedin.com/in/lucas-zebre-22305a191/" target="_blank"><img src={linkedin} alt="linkedin" className='max-md:w-[3vw] mr-[1vw] max-md:min-w-[19.2px] md:w-[3vw] lg:w-[2vw]' /></a>
                <a href="https://twitter.com/ZebreLucas" target="_blank"><img src={twitter} alt="twitter-logo" className='max-md:w-[3vw] mr-[1vw] max-md:min-w-[19.2px] md:w-[3vw] lg:w-[2vw]' /></a>
