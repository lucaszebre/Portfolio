   ...
   const controls = useAnimation();
            ...
            <div   className="flex md:flex-row md:gap-8 flex-col items-center justify-start w-full "  >
                ...
                width='fit-content'>
                    <div className="flex flex-row gap-2  md:hidden items-center justify-between">
                        <a href="https://github.com/lucaszebre" target="_blank"><img className='w-[3vw] mr-[1vw] min-w-[19.2px] lg:w-[2vw]' src={github} alt="github-icon" /></a>
                        <a href="https://www.frontendmentor.io/profile/Kihura" target="_blank"><img className='w-[3vw] mr-[1vw] min-w-[19.2px] lg:w-[2vw]' src={frontend} alt="frontend-icon" /></a>
                        <a href="https://www.linkedin.com/in/lucas-zebre-22305a191/" target="_blank"><img className='w-[3vw] mr-[1vw] min-w-[19.2px] lg:w-[2vw]' src={linkedin} alt="linkedin-icon" /></a>
                        <a href="https://twitter.com/ZebreLucas" target="_blank"><img className='w-[3vw] mr-[1vw] min-w-[19.2px] lg:w-[2vw]' src={twitter} alt="twitter-icon" /></a>
    ...
    //    }} 
       className='hidden lg:w-[30.903vw] h-[50vw] absolute z-[-33] right-0 top-0 top-0 lg:block' src={PhotoProfileDesktop} alt="Photo de lucas zebre " />
            ...
            <img className='md:hidden block w-[50%] h-[95vw] absolute z-[-33] top-0' src={PhotoProfileMobile} alt="Photo de lucas zebre " />

            <img className='lg:hidden md:block hidden w-[31.445vw] h-[58.594vw] absolute z-[-33] right-0 top-0' src={PhotoProfileTablet} alt="Photo de lucas zebre " />
