      ...
      >
        ...
        <div className="flex flex-col items-center justify-center max-w-[1440px] w-[80%] relative">
          <div className="flex md:flex-row md:gap-10 flex-col  items-center text-start justify-center lg:justify-start w-full ">
            ...
            >
              <h1 className="text-[1rem] cursor-pointer font-bold text-white mb-[0.5rem] md:text-[3vw] lg:text-[2vw]">
                lucaszebre
              </h1>
            </Reveal>
            ...
            <span
              ...
              className="text-white   font-bold md:flex hidden cursor-pointer hover:decoration-1 hover:underline hover:decoration-[#00ff80]"
            >
          ...
          <div className="mt-[4rem]  lg:items-start items-center text-center gap-[2rem]  lg:text-start w-full flex  flex-col-reverse lg:flex-row ">
            <div className="flex flex-col lg:items-start items-center w-[70%] gap-4 ">
              ...
              <div
                onClick={() => onClick("contact")}
                className="text-[5vw] lg:text-[2vw] justify-center  flex text-white cursor-pointer font-400 mb-[2em] decoration-4 underline decoration-[#00ff80]"
              >
                {t("contactMe")}
              </div>
            </div>
            ...
            {/* <div className='hidden lg:w-[34vw] h-[35vw] w-full  max-w-[408px]  max-h-[400px]  relative lg:block'>
                <Image fill={true}  src={PhotoProfileDesktop} alt={t('alt.profile')} />
